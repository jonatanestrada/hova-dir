              ...
              <tbody>
                <tr ng-repeat="m in miembros" ng-class="{rowBajaEmpleado: m.active == 0}">
				  ...
				  <td style='padding-left: 60px;'>
						...
						<img ng-show='m.active==1 && !m.accesoPortal' src='/img/key_red.png' ng-click='darAltaPortal(m)' data-toggle="modal" data-target="#modalAltaPortal" class='btnImg'>
						<img ng-show='m.active==1 && m.accesoPortal' src='/img/key.png' ng-click='darBajaPortal(m)' data-toggle="modal" data-target="#modalBajaPortal" class='btnImg'>
				  </td>
                </tr>
