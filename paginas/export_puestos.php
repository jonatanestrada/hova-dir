...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->setCellValue('J1', 'A paterno')
			->setCellValue('K1', 'A Materno')
			->setCellValue('L1', 'Cumpleaños')
			->setCellValue('M1', 'Tel. Directo')
			->setCellValue('N1', 'Observaciones2')
			->setCellValue('O1', 'Celular')
			->setCellValue('P1', 'E-Mail')
			->setCellValue('Q1', 'Edad')
			->setCellValue('R1', 'F. Ingreso')
			->setCellValue('S1', 'Antigüedad')
			->setCellValue('T1', 'Disp. L')
			->setCellValue('U1', 'Disp. M')
			->setCellValue('V1', 'Disp. Mc')
			->setCellValue('W1', 'Disp. J')
			->setCellValue('X1', 'Disp. V')
			->setCellValue('U1', 'Disp. S')
			->setCellValue('Y1', 'Disp. D')
			->setCellValue('Z1', 'ID Directorio')
...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->setCellValue('J'.$i, $m['apaterno'])
			->setCellValue('K'.$i, $m['amaterno'])
			->setCellValue('L'.$i, 'NULL')
			->setCellValue('M'.$i, $m['telefono_directo'])
			->setCellValue('N'.$i, $m['observaciones2'])
			->setCellValue('O'.$i, $m['celular'])
			->setCellValue('P'.$i, $m['email'])
			;
